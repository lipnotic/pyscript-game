...
def tocar_audio(caminho):
    ...
    audio.src = caminho
    audio.load()
    audio.play()#tentar executar audio
    try:
        audio.play()
    except Exception:
        pass
...
# ------------------------------------------------------------
definir_titulo("ALVORECER DOS DEUSES", "Felipe Garbin")
...
# ============================================================
def cena_inicio():
    mostrar_imagem("assets/inicio.png")

    print("\n" + "=" * 50)
    print("ALVORECER DOS DEUSES")
    print("=" * 50)
...
""")
    ...
    opcao = escolher("Escolha: ", ["1", "2"])
    if opcao == "1":
        return "cena_a"
    return "cena_b"

def cena_a():
    mostrar_imagem("assets/cena_a.png")
...
""")
    ...
    if "chave" not in estado["inventario"]:
        ...
        estado["inventario"].append("chave")
...
def cena_b():
    mostrar_imagem("assets/cena_b.jpg")
...
def cena_c():
    mostrar_imagem("assets/cena_c.jpg")

    print("\nNesta cena você pode verificar o inventário.")

    if "chave" in estado["inventario"]:
        print("A chave abre uma passagem secreta!")
        return "final_bom"

    print("Você não possui o item necessário.")
    return "final_ruim"

def cena_d():
    mostrar_imagem("assets/cena_d.jpg")
...
def final_bom():
    mostrar_imagem("assets/final_bom.jpg")
    print("""
================================
🏆 FINAL BOM
================================
...
def final_ruim():
    mostrar_imagem("assets/final_ruim.jpg")
    print("""
================================
💀 FINAL RUIM
================================
